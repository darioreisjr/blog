...
export function SocialShare({ url, title, description }: SocialShareProps) {
  ...
  return (
    <div className="my-8 p-6 border border-border rounded-lg bg-muted/50">
      ...
      <div className="flex flex-wrap gap-3">
        {shareLinks.map((link) => (
          <Button
            ...
            variant="outline"
            size="sm"
            className={`${link.bgColor} ${link.color} transition-all duration-200 border-border/50`}
      ...
      <p className="text-sm text-muted-foreground mt-4">
        Gostou do conteúdo? Compartilhe com seus amigos e colegas!
      </p>
    </div>
  );
}
